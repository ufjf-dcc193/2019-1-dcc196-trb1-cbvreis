    ...
    <div class="container">
        ...
        <form method="POST" action="/../atividades/editar">
                ...
                <label for="tituloAtividade">Título da atividade</label>
                    ...
                    <input id="id_sede" name="id_sede" type="hidden" value="${sede.id}"/> 
                    <input type="text" class="form-control" value = "${atividade.titulo}" name="titulo" id="tituloAtividade"
                    placeholder="Digite o título da atividade" required>
            </div>
            <div class="form-group">
                <label for="textoAtividade">Texto de descrição</label> <br />
                <textarea class="form-control" value = "${atividade.descricao}" name="descricao">Descreva a atividade</textarea>
            </div>
            <div class="form-group">
                <label for="categoria">Escolha a categoria</label>
                <select name="categoria"  value = "${atividade.categoria}" class="form-control" id="categoria" required>
            ...
            <div class="form-group">
                ...
                <input type="number"  value = "${atividade.horasDeAtividade}" class="form-control" name="horasDeAtividade" id="horasDeAtividade"
                    placeholder="Horas de atividade (Utilize somente números)" required>
            </div>
            <div class="form-group">
                <label for="dataDeInicio">Data de entrada</label>
                <input type="date" class="form-control" value = "${atividade.dataDeInicio}" name="dataDeInicio" id="dataDeInicio"
                    placeholder="Digite a data de início" required>
            </div>
            <div class="form-group">
                <label for="dataDeFim">Data de saída</label>
                <input type="date" class="form-control" value = "${atividade.dataDeFim}" name="dataDeFim" id="dataDeFim"
